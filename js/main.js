...
function updateWallet() {
  ...
  if (typeof web3 !== "undefined") {
    ...
    if (typeof walletAddress !== "undefined") {
      $("#status").html(walletAddress);
    }
    if (typeof walletAddress == "undefined") {
      $("#status").html("Please Unlock Wallet");
    }
...
let cyclABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "_presaleBurn", type: "bool" },
    ],
    name: "burn",
    outputs: [{ internalType: "bool", name: "success", type: "bool" }],
    stateMutability: "nonpayable",
...
let lpSynthABI = null;
//Contracts------------------------------------------------------------------------------------------
let usdtContract = web3.eth
  .contract(usdtABI)
  .at("0xdAC17F958D2ee523a2206206994597C13D831ec7");
let usdcContract = web3.eth
  .contract(usdcABI)
  .at("0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48");
let daiContract = web3.eth
  .contract(daiABI)
  .at("0x6B175474E89094C44Da98b954EedeAC495271d0F");
let cyclContract = web3.eth
  .contract(cyclABI)
  .at("0x69f08bD1929eF62ecBE947d6Bf76a7B7CdbA55e8");
let lpContract = web3.eth
  .contract(lpABI)
  .at("0xC5a7F9C72f33dFBf9B3F2e2dFc8b40bd0499E92f");
...
function clicked(clickedId) {
  ...
  const content = [
    ...
    },
    {
      ...
      title: "Stake yfUSDT",
      description:
        "Once you have exchanged your USDT for yfUSDT send them here to officially start earning emission rewards.",
      ctaText: "Stake!",
      showAmount: true,
      imsageSrc: "images/usdt.PNG",
    },
    ...
    },
    {
      ...
      title: "Stake yfUSDC",
      description:
        "Once you have exchanged your USDC for yfUSDC send them here to officially start earning emission rewards.",
      ctaText: "Stake!",
      showAmount: true,
      imsageSrc: "images/usdc.PNG",
    },
    ...
    },
    {
      ...
      title: "Stake yfDAI",
      description:
        "Once you have exchanged your DAI for yfDAI send them here to officially start earning emission rewards.",
      ctaText: "Stake!",
      showAmount: true,
      imsageSrc: "images/dai.PNG",
    },
