...
function updateWallet() {
	// Check if Web3 object is injected by Ethereum compatible browser such as MetaMask
	if (typeof web3 !== 'undefined') {
		// Initialize Web3 using a provider of MetaMask
		web3js = new Web3(web3.currentProvider);
		//Get list of accounts
		account = web3js.eth.accounts;
		//Get currently active account if possible
		walletAddress = account[0];
		//Check if wallet is unlocked or not
		if (typeof walletAddress !== 'undefined') { $('#status').html(walletAddress)}
		if (typeof walletAddress == 'undefined') { $('#status').html("Please Unlock Wallet")}
	}
...
let usdcABI = [{"constant":false,"inputs":[{"name":"newImplementation","type":"address"}],"name":"upgradeTo","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":false,"inputs":[{"name":"newImplementation","type":"address"},{"name":"data","type":"bytes"}],"name":"upgradeToAndCall","outputs":[],"payable":true,"stateMutability":"payable","type":"function"},{"constant":true,"inputs":[],"name":"implementation","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":false,"inputs":[{"name":"newAdmin","type":"address"}],"name":"changeAdmin","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[],"name":"admin","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"inputs":[{"name":"_implementation","type":"address"}],"payable":false,"stateMutability":"nonpayable","type":"constructor"},{"payable":true,"stateMutability":"payable","type":"fallback"},{"anonymous":false,"inputs":[{"indexed":false,"name":"previousAdmin","type":"address"},{"indexed":false,"name":"newAdmin","type":"address"}],"name":"AdminChanged","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"name":"implementation","type":"address"}],"name":"Upgraded","type":"event"}];
...
let yfdaiABI = null; 
let yfcyclABI = null; 
let usdtSynthABI = null; 
let usdcSynthABI = null; 
let daiSynthABI = null; 
let cyclSynthABI = null; 
let lpSynthABI = null; 
//Contracts------------------------------------------------------------------------------------------
let usdtContract = web3.eth.contract(usdtABI).at("0xdAC17F958D2ee523a2206206994597C13D831ec7");
let usdcContract = web3.eth.contract(usdcABI).at("0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48");
let daiContract = web3.eth.contract(daiABI).at("0x6B175474E89094C44Da98b954EedeAC495271d0F");
let cyclContract = web3.eth.contract(cyclABI).at("0x69f08bD1929eF62ecBE947d6Bf76a7B7CdbA55e8");
let lpContract = web3.eth.contract(lpABI).at("0xC5a7F9C72f33dFBf9B3F2e2dFc8b40bd0499E92f");
